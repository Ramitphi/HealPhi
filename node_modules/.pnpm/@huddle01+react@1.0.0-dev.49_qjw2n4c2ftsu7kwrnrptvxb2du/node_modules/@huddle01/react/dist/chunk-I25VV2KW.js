...
var import_common = __toESM(require_common_types(), 1);
...
var useActivePeers = () => {
  ...
  const handleNewVolatileMessage = useCallback((data) => {
    if (data.label !== "lastN")
      return;
...
//# sourceMappingURL=chunk-I25VV2KW.js.map